...
const UserProfile = () => {
    ...
    const deleteproduct = async (id) => {
        let result = await fetch(`${Api}MAS_WDH/${id} `, {
          method: "Delete",});
    ...
    const getproducts = async () => {
        let result = await fetch(`${Api}MAS_WDH`);
        result = await result.json();
        setdata(result)
    };

    const handleSubmit = async () => {
        const result = fetch(`${Api}MAS_WDH`, {
            method: "post",
                    ...
                    <Col lg="3" className="col-lg-3">
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Button variant="btn btn-primary" onClick={handleSubmit}>Add</Button>{' '}
                            </Card.Body>
                        </Card>
                    </Col>
                                  ...
                                  <ul className="list-inline m-0 p-0">
                                      <li className="d-flex mb-2">
                                          ...
                                          <div style={{float:"right"}}>
                                                <Link className="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Edit User"   to={"/dashboard/app/MASW_x_D_x_H_Update/" + item._id} >

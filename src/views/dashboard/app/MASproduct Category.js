...
const UserProfile = () => {
    ...
    const handleSubmit = async () => {
        const result = fetch(`${Api}MASproductCategory`, {
            method: "post",
                                  ...
                                  <ul className="list-inline m-0 p-0">
                                      <li className="d-flex mb-2">
                                          ...
                                          <div style={{float:"right"}}>
                                                <Link className="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="Edit User"   to={"/dashboard/app/MASproduct_Category_Update/" + item._id} >

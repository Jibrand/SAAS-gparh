...
// img
const rfqupvendor = ({ currentId, setCurrentId }) => {
                            ...
                            <Form.Group className="form-group">
                              ...
                              >
                                <input
                                  ...
                                  name="dateime"
                                  className="form-control"
                                  value={postData.date_and_time_picker}
                                  onChange={(e) =>
                                    setPostData({
                                      ...postData,
                                      date_and_time_picker: e.target.value,
                                    })
                                  }
                                />
                              </select>
                        ...
                        <div className="col-md-3">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              className="form-control"
                              value={
                                postData.any_other_instructions_for_quoting
                              }
                              onChange={(e) =>
                                setPostData({
                                  ...postData,
